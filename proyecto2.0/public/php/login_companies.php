<?php
   include("../../private/php/empresas/sesiones_login/config.php");
   session_start();
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT usuario FROM empresas WHERE usuario = '$myusername' and password = '$mypassword'";
      ...
      if($count == 1) {
         ...
         header("location: ../../private/php/empresas/welcome.php");
      }else {
